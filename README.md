...
- ✅ **Подзадачи** - чек-листы для больших задач с отслеживанием прогресса
- 📋 **Шаблоны задач** - создание переиспользуемых шаблонов для повторяющихся задач
- 🔄 **Drag & Drop** - визуальное переупорядочивание задач с автосохранением
- 🔍 **Умный поиск** - мгновенный поиск с подсветкой результатов и множественной фильтрацией
- 💾 **Экспорт/Импорт шаблонов** - перенос шаблонов между аккаунтами в JSON
