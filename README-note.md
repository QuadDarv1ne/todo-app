...
#### Генерация теста через `Artisan`

```bash
# Создание unit-теста для класса User
php artisan make:test UserTest --unit

# Создание unit-теста для класса Task
...
📃 **Для анализа покрытия кода unit-тестами можно использовать**

```bash
# Генерация отчета о покрытии в HTML
php artisan test --testsuite=Unit --coverage --coverage-html=coverage
