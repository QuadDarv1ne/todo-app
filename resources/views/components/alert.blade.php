...
<div {{ $attributes->merge(['class' => "border rounded-xl p-5 {$colors[$type]} transition-all duration-200"]) }} role="alert">
    <div class="flex items-start">
        ...
        @if($dismissible)
            <button type="button" class="ml-4 flex-shrink-0 text-gray-400 hover:text-gray-500 transition-colors duration-200" onclick="this.parentElement.parentElement.remove()">
