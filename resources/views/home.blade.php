...
<body>
        ...
        <div class="grid grid-4">
            @foreach([
                ...
                <div class="card">
                    ...
                    <h3 style="font-weight: 600; margin-bottom: 0.5rem;">{{ $feature['title'] }}</h3>
                    <p style="font-size: 0.875rem; color: #6b7280;">{{ $feature['desc'] }}</p>
                </div>
            @endforeach
        </div>
    </section>
        ...
        <div class="grid grid-2">
            @foreach([
                ...
                <div class="card">
                    ...
                    <p style="margin-bottom: 1rem; color: #4b5563;">{{ $testimonial['text'] }}</p>
                    <div class="stars">★★★★★</div>
                </div>
            @endforeach
        </div>
    ...
    <section class="cta-section">
        <div style="text-align: center; max-width: 600px; margin: 0 auto;">
            ...
            <a href="{{ route('register') }}" class="btn btn-primary">Зарегистрироваться бесплатно</a>
        </div>
    </section>
