    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = $recommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recommendation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-start gap-4 p-4 rounded-lg border <?php echo e($recommendation['urgency'] === 'high' ? 'bg-red-50 border-red-200 dark:bg-red-900/30 dark:border-red-700' : ($recommendation['urgency'] === 'medium' ? 'bg-yellow-50 border-yellow-200 dark:bg-yellow-900/30 dark:border-yellow-700' : 'bg-blue-50 border-blue-200 dark:bg-blue-900/30 dark:border-blue-700')); ?>">
                    <!-- Иконка -->
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1"><?php echo e($recommendation['title']); ?></h4>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2"><?php echo e($recommendation['description']); ?></p>
                        <a href="<?php echo e($recommendation['action_url']); ?>" 
                           class="inline-flex items-center text-sm font-medium <?php echo e($recommendation['urgency'] === 'high' ? 'text-red-700 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300' : ($recommendation['urgency'] === 'medium' ? 'text-yellow-700 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300' : 'text-blue-700 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300')); ?>">
...
<?php if(isset($nextTask) && $nextTask): ?>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border-2 border-indigo-200 dark:border-indigo-700 p-6 mb-6">
        ...
        <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2"><?php echo e($nextTask->title); ?></h4>
        <?php if($nextTask->description): ?>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-3"><?php echo e(Str::limit($nextTask->description, 100)); ?></p>
        <?php endif; ?>
