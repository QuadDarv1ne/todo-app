...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 py-8 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8 transition-colors duration-300">
            <form action="<?php echo e(route('tasks.index')); ?>" method="GET" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent transition-all dark:text-gray-100"
                        >
                            <option value="all" <?php echo e($filter === 'all' ? 'selected' : ''); ?>>Все задачи</option>
                            <option value="active" <?php echo e($filter === 'active' ? 'selected' : ''); ?>>Активные</option>
                            <option value="completed" <?php echo e($filter === 'completed' ? 'selected' : ''); ?>>Завершённые</option>
                            <option value="today" <?php echo e($filter === 'today' ? 'selected' : ''); ?>>На сегодня</option>
                            <option value="week" <?php echo e($filter === 'week' ? 'selected' : ''); ?>>На неделю</option>
                            <option value="overdue" <?php echo e($filter === 'overdue' ? 'selected' : ''); ?>>Просроченные</option>
                        </select>
                    </div>
                    ...
                    <!-- Tag -->
                    <?php if($userTags && $userTags->isNotEmpty()): ?>
                    <div>
                        ...
                        >
                            ...
                            <?php $__currentLoopData = $userTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(route('tasks.index')); ?>" class="inline-flex items-center gap-2 px-6 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-all transform hover:-translate-y-0.5">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php else: ?>
            ...
            <div class="mb-4 flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400">
                    Всего задач: <?php echo e($tasks->total()); ?>
            ...
            <div class="grid grid-cols-1 gap-4" data-tasks-container>
                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="task-card group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden <?php echo e($task->completed ? 'opacity-75' : ''); ?>" data-task-id="<?php echo e($task->id); ?>">
                        <!-- Priority Bar -->
                        <div class="h-1.5 <?php echo e($task->priority === 'high' ? 'bg-red-500' : ($task->priority === 'medium' ? 'bg-yellow-500' : 'bg-green-500')); ?>"></div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-grow">
                                            <h3 class="task-title text-lg font-bold <?php echo e($task->completed ? 'line-through text-gray-500 dark:text-gray-500' : 'text-gray-900 dark:text-gray-100'); ?> mb-2">
                                                <?php echo e($task->title); ?>

                                            </h3>
                                            
                                            <?php if($task->description): ?>
                                                <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed"><?php echo e($task->description); ?></p>
                                            <?php endif; ?>
                                            ...
                                            <div class="mt-4 flex flex-wrap gap-2 text-sm">
                                                ...
                                                <?php if($task->priority): ?>
                                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold shadow-sm
                                                        <?php echo e($task->priority === 'high' ? 'bg-gradient-to-r from-red-500 to-red-600 text-white' : ''); ?>

                                                        <?php echo e($task->priority === 'medium' ? 'bg-gradient-to-r from-yellow-400 to-yellow-500 text-white' : ''); ?>

                                                        <?php echo e($task->priority === 'low' ? 'bg-gradient-to-r from-green-500 to-green-600 text-white' : ''); ?>
                                                ...
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold
                                                    <?php echo e($task->completed ? 'bg-green-50 text-green-700 border border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-700' : 'bg-indigo-50 text-indigo-700 border border-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-700'); ?>
                                                ...
                                                <!-- Tags -->
                                                <?php if($task->tags && $task->tags->isNotEmpty()): ?>
                                        ...
                                        <div class="flex-shrink-0 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button 
                                                    ...
                                                    data-open-subtasks="<?php echo e($task->id); ?>"
                                                    title="Подзадачи"
                                                    aria-label="Управление подзадачами: <?php echo e($task->title); ?>"
                                                >
                                            ...
                                            <button 
                                                ...
                                                data-id="<?php echo e($task->id); ?>"
                                                title="Редактировать"
                                                aria-label="Редактировать задачу: <?php echo e($task->title); ?>"
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                            ...
                                            <button 
                                                ...
                                                data-id="<?php echo e($task->id); ?>"
                                                title="Удалить"
                                                aria-label="Удалить задачу: <?php echo e($task->title); ?>"
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
...
<div id="createTaskModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
            <form action="<?php echo e(route('tasks.store')); ?>" method="POST" id="createTaskForm">
                <?php echo csrf_field(); ?>
