<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('achievements.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium">
                Все достижения →
            </a>
        </div>
        ...
        <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/40 dark:to-purple-950/40 rounded-lg p-4 mb-4">
            <div class="flex items-center justify-between mb-3">
                <div>
                    ...
                    <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400"><?php echo e(auth()->user()->level); ?></div>
                </div>
                <div class="text-right">
                    <div class="text-sm text-gray-600 dark:text-gray-400">Опыт</div>
                    <div class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e(auth()->user()->experience_points); ?> XP</div>
                </div>
            </div>
            ...
            <div class="w-full bg-white dark:bg-gray-700 rounded-full h-3 overflow-hidden shadow-inner">
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 h-3 rounded-full transition-all duration-500 <?php echo e($progressClass); ?>"></div>
            </div>
        ...
        <div class="grid grid-cols-2 gap-3 mb-4">
            <div class="bg-green-50 dark:bg-green-900/30 rounded-lg p-3">
                ...
                <div class="text-xl font-bold text-green-900 dark:text-green-300"><?php echo e(auth()->user()->streak_days); ?> 🔥</div>
            </div>
