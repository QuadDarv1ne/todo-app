...
<head>
    ...
    <title><?php echo e($title ?? 'Maestro7IT'); ?></title>
...
<body>
    <div class="container">
        <div class="card">
            <!-- Back Link -->
            <a href="<?php echo e(route('home')); ?>" class="back-link" aria-label="На главную">
            ...
            <div class="tabs" role="tablist" aria-label="Авторизация" id="auth-tablist">
                <button id="tab-login" role="tab" aria-controls="login" aria-selected="<?php echo e((request()->routeIs('login') && !old('name')) ? 'true' : 'false'); ?>" class="tab <?php echo e(request()->routeIs('login') && !old('name') ? 'active' : ''); ?>" onclick="switchTab('login', event)" data-tab="login">Вход</button>
                <button id="tab-register" role="tab" aria-controls="register" aria-selected="<?php echo e(old('name') ? 'true' : 'false'); ?>" class="tab <?php echo e(old('name') ? 'active' : ''); ?>" onclick="switchTab('register', event)" data-tab="register">Регистрация</button>
            </div>

            <!-- Login Tab -->
            <div id="login" role="tabpanel" aria-labelledby="tab-login" class="tab-content <?php echo e(request()->routeIs('login') && !old('name') ? 'active' : ''); ?>">
                <?php if($errors->any()): ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="error-message show" role="alert" id="email-error"><?php echo e($message); ?></div>
                        <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="error-message show" role="alert" id="password-error"><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="forgot-link">Забыли пароль?</a>
                    <?php endif; ?>
            ...
            <!-- Register Tab -->
            <div id="register" role="tabpanel" aria-labelledby="tab-register" class="tab-content <?php echo e(old('name') ? 'active' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="email-reg">Email</label>
                           <input type="email" id="email-reg" name="email" value="<?php echo e(old('email')); ?>" 
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const hasRegistrationData = "<?php echo e(old('name') ? '1' : '0'); ?>";
            const hasLoginErrors = "<?php echo e((($errors->has('email') || $errors->has('password')) && !old('name')) ? '1' : '0'); ?>";
...
</html><?php /**PATH C:\Users\maksi\OneDrive\Documents\GitHub\todo-app\resources\views/auth/login.blade.php ENDPATH**/ ?>