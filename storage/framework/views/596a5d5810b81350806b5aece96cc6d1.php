<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('activity-logs.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium">
                Вся история →
            </a>
        </div>
        ...
        <?php if($recentLogs->isNotEmpty()): ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $recentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border-l-4 border-<?php echo e($log->action_color); ?>-500 bg-<?php echo e($log->action_color); ?>-50 dark:bg-<?php echo e($log->action_color); ?>-900/30 p-3 rounded-r-lg">
                        <div class="flex items-start gap-2">
                            <span class="text-xl"><?php echo e($log->action_icon); ?></span>
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-1">
                                    <span class="text-sm font-semibold text-gray-900 dark:text-gray-100"><?php echo e($log->action_label); ?></span>
                                    <?php if($log->model_type): ?>
                                        <span class="text-xs px-2 py-0.5 bg-<?php echo e($log->action_color); ?>-200 text-<?php echo e($log->action_color); ?>-800 dark:bg-<?php echo e($log->action_color); ?>-900/30 dark:text-<?php echo e($log->action_color); ?>-300 rounded-full">
                                            <?php echo e(class_basename($log->model_type)); ?>

                                        </span>
                                    <?php endif; ?>
                                </div>
                                <p class="text-xs text-gray-700 dark:text-gray-300 line-clamp-2"><?php echo e($log->description); ?></p>
                            </div>
