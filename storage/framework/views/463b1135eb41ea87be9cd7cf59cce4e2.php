    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden md:flex gap-6">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('donations.my')); ?>" 
                           class="px-1 py-2 text-sm font-medium <?php echo e(request()->routeIs('donations.*') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-700 hover:text-gray-900'); ?> transition">
                            Донаты
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="hidden sm:flex items-center gap-2 relative group">
                        ...
                        <div class="absolute right-0 mt-0 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 top-full">
                            ...
                            <a href="<?php echo e(route('donations.my')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Мои донаты</a>
        ...
        <div x-show="mobileMenuOpen" x-transition class="md:hidden pb-4 space-y-2">
            <?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e(route('donations.my')); ?>" 
                   class="block px-4 py-2 rounded-lg <?php echo e(request()->routeIs('donations.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?> transition">
                    Донаты
                </a>
